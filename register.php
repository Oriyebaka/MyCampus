            ...
            <div class="col-xl-7 vh-100 align-items-center d-flex bg-white rounded-3 overflow-hidden">
                <div class="card shadow-none border-0 ms-auto me-auto login-card">
                    <div class="card-body rounded-0 text-left">
                        <h2 class="fw-700 display1-size display2-md-size mb-3">Create<br>your account</h2>
                        <form action="func/register" method="POST" onsubmit="disablebtn()">
                            <div class="form-group icon-input mb-3">
                                <i class="font-sm ti-user text-grey-500 pe-0"></i>
                                <input type="text" name="username" class="style2-input ps-5 form-control text-grey-900 font-xsss fw-600" value="<?php if (isset($_SESSION["form_data"])) { echo $_SESSION["form_data"][0]; } ?>" placeholder="Your Userame" required>
                            </div>
                            <div class="form-group icon-input mb-3">
                                <i class="font-sm ti-email text-grey-500 pe-0"></i>
                                <input type="email" name="email" class="style2-input ps-5 form-control text-grey-900 font-xsss fw-600" value="<?php if (isset($_SESSION["form_data"])) { echo $_SESSION["form_data"][1]; } ?>" placeholder="Your Email Address" required>
                            </div>
                            <div class="form-group icon-input mb-3">
                            ...
                            <div class="form-group icon-input mb-1">
                                <input type="password" name="confirm" class="style2-input ps-5 form-control text-grey-900 font-xss ls-3" placeholder="Confirm Password" required>
                                <i class="font-sm ti-lock text-grey-500 pe-0"></i>
                            </div>
                            ...
                            <div class="col-sm-12 p-0 text-left">
                                <div class="form-group mb-1">
                                    <button type="submit" id="submitbtn" class="form-control text-center style2-input text-white fw-600 bg-dark border-0 p-0">Register</button>
                                </div>
                                <h6 class="text-grey-500 font-xsss fw-500 mt-0 mb-0 lh-32">Already have an account <a href="login" class="fw-700 ms-1">Login</a></h6>
                            </div>
                        </form>
                    </div>
                </div> 
