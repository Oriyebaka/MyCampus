<!-- <form action="func/post" method="post">
    <div class="card w-100 shadow-xss rounded-xxl border-0 ps-4 pt-4 pe-4 pb-3 mb-5">
        ...
        <div class="card-body p-0 mt-3 position-relative">
            ...
            <textarea name="post" class="h100 bor-0 w-100 rounded-xxl p-2 ps-5 font-xssss text-grey-500 fw-500 border-light-md theme-dark-bg" cols="30" rows="10" placeholder="What's on your mind?" required><?php if (isset($_SESSION["form_data"])) { echo $_SESSION["form_data"][0]; } ?></textarea>
        </div>
