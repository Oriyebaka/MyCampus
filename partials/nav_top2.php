...
<div class="nav-header bg-white shadow-xs border-0">
    ...
    <a href="<?= $getuser["username"] ?>" class="p-0 ms-3 menu-icon"><img src="../<?= $getuser["picture"] ?>" alt="<?= $getuser["id"] ?>" style="object-fit:cover; border-radius:50%;" height="40px" width="40px"></a>
