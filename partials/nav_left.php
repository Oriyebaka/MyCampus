    ...
    <div class="container ps-0 pe-0">
        <div class="nav-content">
            ...
            <div class="nav-wrap bg-white bg-transparent-card rounded-xxl shadow-xss pt-3 pb-1">
                ...
                <ul class="mb-1">
                    <li class="logo d-none d-xl-block d-lg-block"></li>
                    <li><a href="settings" class="nav-content-bttn open-font h-auto pt-2 pb-2"><i class="font-sm feather-settings me-3 text-grey-500"></i><span>Settings</span></a></li>
                    <li><a href="analytics" class="nav-content-bttn open-font h-auto pt-2 pb-2"><i class="font-sm feather-pie-chart me-3 text-grey-500"></i><span>Analytics</span></a></li>
                    <li><a href="logout" class="nav-content-bttn open-font h-auto pt-2 pb-2"><i class="font-sm feather-power me-3 text-danger fw-900"></i><span>Logout</span></a></li>
                </ul>
            </div>
        </div>
    </div>
